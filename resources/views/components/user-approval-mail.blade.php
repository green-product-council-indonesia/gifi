...
@section('content')
<table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #d7f5e3;" cellpadding="0" cellspacing="0" role="presentation">
    <tbody>
        <tr>
            <td>
                <div role="banner">
                    ...
                    <div class="header" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);" id="emb-email-header-container">
                        ...
                        <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
                            {{-- <div class="logo-center" align="center" id="emb-email-header"><img style="display: block;height: auto;width: 100%;border: 0;max-width: 141px;" src="{{ $message->embed('img/gtri.png') }}" alt="" width="141" /></div> --}}
                        </div>
                        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
                    </div>
                </div>
                            ...
                            <div class="column" style="text-align: left;color: #8e959c;font-size: 14px;line-height: 21px;font-family: sans-serif;">
                                ...
                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                        <h1 class="size-24" style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #000;font-size: 20px;line-height: 28px;font-family: bitter,georgia,serif;text-align: center;" lang="x-size-24">
                    ...
                    <div class="layout one-col fixed-width stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #fff;">
                            ...
                            <div class="column" style="text-align: left;color: #8e959c;font-size: 14px;line-height: 21px;font-family: sans-serif;">
                                ...
                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                        <p class="size-16" style="Margin-top: 0;Margin-bottom: 0;font-family: bitter,georgia,serif;font-size: 16px;line-height: 24px;text-align: center;" lang="x-size-16">
                                            <span class="font-bitter">
                                                <span style="color:#000000">Terima kasih atas Registrasi di Portal
                                                    Client Green Toll Road Indonesia atas
                                                    <b>{{ Str::upper($name) }}</b>.
                                                </span>
                                            </span>
                                        </p>
                                        <p class="size-16" style="Margin-top: 20px;Margin-bottom: 0;font-family: bitter,georgia,serif;font-size: 16px;line-height: 24px;text-align: center;" lang="x-size-16"><span class="font-bitter"><span style="color:#000000">Registrasi akun anda sudah kami terima dan
                                                    saat ini web client GTRI sudah bisa diakses
                                                </span>
                                                <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #18527c;" href="{{ route('login') }}">
                                        ...
                                        <p class="size-16" style="Margin-top: 20px;Margin-bottom: 0;font-family: bitter,georgia,serif;font-size: 16px;line-height: 24px;text-align: center;" lang="x-size-16"><span class="font-bitter"><span style="color:#000000">dengan memasukan email dan password terdaftar
                                                    untuk melanjutkan pendaftaran sertifikasi Green Toll Road Indonesia
                                                </span>
                                            </span>
                                        </p>
                                        <p class="size-16" style="Margin-top: 20px;Margin-bottom: 20px;font-family: bitter,georgia,serif;font-size: 16px;line-height: 24px;text-align: center;" lang="x-size-16">
                                            <span class="font-bitter">
