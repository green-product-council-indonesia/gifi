                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div
                                            ...
                                            <p class="size-16"
                                                ...
                                                lang="x-size-16">
                                                <span class="font-bitter">
                                                    <span style="color:#000000">Dokumen tersebut sudah berhasil diupload
                                                        oleh pihak verifikator dan dapat diteruskan untuk validasi
                                                        sertifikasi</span>
                                                    <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #18527c;"
                                                        href="{{ route('approve-sertifikasi') }}">
