...
<div>
    ...
    <div class="p-4 mt-4 bg-white border border-green-200 rounded-md shadow-md" x-data="{ openTab: 1, active: 'bg-blue-600 shadow-md hover:bg-blue-800', inactive: 'bg-transparent', teks: 'Informasi' }">
        <div id="tabs" class="flex flex-col w-full px-4 py-4 border border-green-300 rounded-md shadow-md sm:space-x-4 sm:flex-row">
            <div :class="openTab === 1 ? active : inactive" class="px-4 py-2 text-xs text-gray-800 rounded-md ">
                <button @click="openTab = 1" :class="openTab === 1 ? 'font-semibold text-white' : 'hover:text-blue-800'">Informasi Umum</button>
            </div>
            ...
            <div :class="openTab === 3 ? active : inactive" class="px-4 py-2 text-xs text-gray-800 rounded-md">
                <button @click="openTab = 3" :class="openTab === 3 ? 'font-semibold text-white' : 'hover:text-blue-800'">
                    Contact
                </button>
            </div>
        </div>
        ...
        <div class="flex flex-col items-center justify-center gap-4 py-20 mt-4 md:py-32 md:flex-row">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-24 h-24 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
