    ...
    <div class="bg-white divide-y divide-gray-200">
        <div class="flex items-center justify-between px-5 py-4 bg-white">
            <div class="flex items-center space-x-4">
                <p class="text-sm font-semibold text-gray-800">
                    Approve dan Tambah Catatan untuk Dokumen
                </p>
            </div>
        ...
        <div class="grid grid-cols-12 gap-4 p-8">
            <div class="col-span-12">
                ...
                <textarea rows="8"
                    class="block w-full px-2 py-3 mt-1 text-xs border border-gray-300 rounded-md shadow focus:ring-green-300 focus:ring-2 focus:border-green-200 focus:outline-none"
