<div>
    <div class="bg-white divide-y divide-gray-200">
        ...
        <div class="grid grid-cols-12 gap-4 p-8">
            <div class="col-span-12">
                ...
                <textarea rows="8" class="block w-full px-2 py-3 mt-1 border border-gray-300 rounded-md shadow focus:ring-green-300 focus:ring-2 focus:border-green-200 focus:outline-none text-xs"
    ...
    <div class="flex justify-end px-4 py-3 bg-white">
        <button wire:click.prevent="editCatatan"
