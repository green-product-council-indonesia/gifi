<div>
    <div class="bg-white divide-y divide-gray-200">
        ...
        <div class="grid grid-cols-12 gap-4 p-8">
            <div class="col-span-12">
                <p class="text-xs font-semibold">Score : </p>
                <input type="text" class="form-input" placeholder="Score ..." wire:model.lazy="score">
                {{-- <button type="button" wire:loading.attr="disabled" class="mx-1 text-xs"
    ...
    <div class="flex justify-end px-4 py-3 bg-white">
        <button wire:click.prevent="editScore()"
