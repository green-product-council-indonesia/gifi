<div class="flex items-center justify-center px-4 py-2 my-4 font-medium text-green-700 bg-green-100 border border-green-300 rounded-md"
    ...
    <div slot="avatar">
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none" viewBox="0 0 24 24"
            ...
            class="w-8 h-8 mx-2 feather feather-alert-octagon">
    ...
    <div class="items-center flex-initial max-w-full text-xl font-normal">
        <p class="text-sm font-light">{{ session('message') }}</p>
    </div>
