...
<div>
    ...
    <div class="flex items-center justify-end">
        @if ($data->status == 2)
        <button wire:click="$emit('openModal', 'approve.modal.modal-acc', {{ json_encode(['data' => $data->id]) }})" class="px-3 py-2 my-2 text-sm font-medium text-white bg-blue-500 border-2 rounded-md hover:bg-blue-400">
            Approve Sertifikasi
        </button>
