    ...
    <div class="grid grid-cols-12 gap-4">
        <div class="col-span-12 p-4 bg-white border-l-4 border-green-500 rounded-md shadow-lg md:col-span-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-4xl font-bold">{{ count($brand) }}</p>
                    <p class="text-xs tracking-wider text-gray-600">
                        Jumlah Brand Sertifikasi
                    </p>
                </div>
            </div>
        </div>
        <div class="col-span-12 p-4 bg-white border-l-4 border-yellow-500 rounded-md shadow-lg md:col-span-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-4xl font-bold">{{ $brand_is_processing }}</p>
                    <p class="text-xs tracking-wider text-gray-600">
        ...
        <div class="col-span-12 p-4 bg-white border-l-4 border-blue-500 rounded-md shadow-lg md:col-span-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-4xl font-bold">{{ count($brand_is_approved) }}</p>
                    <p class="text-xs tracking-wider text-gray-600">
                        Brand Tersertifikasi
                    </p>
                </div>
            </div>
        </div>
        <div class="col-span-12 md:col-span-7">
            <div class="p-4 bg-white border-l-2 border-indigo-500 rounded-md shadow-lg md:border-l-0 md:border-t-2">
                ...
                @forelse ($brand as $item)
                    ...
                    @break
                @endif
                <div class="gap-4 p-2 mt-4 border-l-4 border-green-400 rounded-md shadow-lg bg-gray-50">
                    <div class="col-span-12 p-2 my-auto">
                        <div class="justify-between mb-2 space-y-2 md:flex">
            ...
            <div class="col-span-12 space-y-4 md:col-span-5">
                <div class="p-4 bg-white border-l-4 border-purple-500 rounded-md shadow-lg">
                    ...
                    @forelse ($brand_is_approved as $item)
                        @if ($loop->iteration > 3)
                        @break
                    @endif
