    ...
    <div class="bg-white divide-y divide-gray-200">
        ...
        <div class="grid grid-cols-12 gap-4 p-8">
            <div class="col-span-12 md:col-span-8">
                <p class="text-xs font-semibold ">Nama Dokumen : </p>
                <textarea rows="9" class="block w-full px-2 py-3 mt-1 text-xs border border-gray-300 rounded-md shadow focus:ring-green-300 focus:ring-2 focus:border-green-200 focus:outline-none"
